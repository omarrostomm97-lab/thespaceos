...
export function HeroSection() {
  ...
  return (
    <section style={{ background: "#050B18", minHeight: "100vh", paddingTop: 64, overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 24px 60px" }}>
        <div className="lp-hero-grid">
          ...
          <div className="lp-hero-left">
            <h1 style={{ fontSize: "clamp(40px, 6vw, 64px)", fontWeight: 800, lineHeight: 1.08, letterSpacing: "-0.03em", marginBottom: 24, color: "white" }}>
              One System.<br />
              <span style={{ color: "#2563EB" }}>Total Control.</span>
            </h1>

            <p style={{ fontSize: 16, color: "#94A3B8", lineHeight: 1.7, marginBottom: 12, maxWidth: 480 }}>
              The Space OS is the all-in-one operations platform for gaming lounges, coworking spaces, cafés, restaurants, and other physical businesses.
            </p>
            <p style={{ fontSize: 15, color: "#64748B", lineHeight: 1.7, marginBottom: 36, maxWidth: 480 }}>
              Manage sessions, orders, staff, shifts, payments, inventory, and reports — in one powerful system.
            </p>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
              <button onClick={() => scrollTo("demo")} style={{
                ...
                background: "#2563EB", color: "white", border: "none", borderRadius: 10, cursor: "pointer",
                fontSize: 15, fontWeight: 600, padding: "13px 24px", fontFamily: "inherit",
          ...
          <div className="lp-hero-right">
            <div style={{
              background: "#0A1628", borderRadius: 14, border: "1px solid rgba(255,255,255,0.1)",
              overflow: "hidden",
              boxShadow: "0 0 80px rgba(37,99,235,0.25), 0 40px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.06)",
            }}>
              {/* Chrome bar */}
              <div style={{
                display: "flex", alignItems: "center", gap: 7, padding: "10px 14px",
                background: "#071020", borderBottom: "1px solid rgba(255,255,255,0.08)",
              }}>
                ...
                <div style={{
                  flex: 1, marginLeft: 8, background: "rgba(255,255,255,0.05)", borderRadius: 5,
