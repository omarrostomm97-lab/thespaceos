...
export function HeroSection() {
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 32px", width: "100%", position: "relative", zIndex: 1 }}>
          ...
          <div className="lp-hero-left">
            <div style={{
              ...
              <span style={{
                ...
                display: "block", boxShadow: "0 0 8px rgba(37,99,235,0.9)",
              }} />
            ...
            <h1 style={{
              fontSize: "clamp(44px, 5.5vw, 70px)", fontWeight: 800,
              lineHeight: 1.03, letterSpacing: "-0.04em", marginBottom: 24, color: "white",
            }}>
              One System.<br />
              <span style={{
            ...
            <p style={{ fontSize: 16, color: "#94A3B8", lineHeight: 1.75, marginBottom: 10, maxWidth: 470 }}>
              The Space OS is the all-in-one operations platform for gaming lounges, coworking spaces,
              cafés, restaurants, and modern businesses.
            </p>
            <p style={{ fontSize: 15, color: "#64748B", lineHeight: 1.7, marginBottom: 36, maxWidth: 470 }}>
              Manage sessions, orders, staff, shifts, payments, inventory, and reports —
              all from one powerful system.
            </p>
