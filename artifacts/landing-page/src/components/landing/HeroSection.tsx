...
export function HeroSection() {
  ...
  return (
    <section
      style={{
        background: "linear-gradient(160deg, #040C1B 0%, #050B18 50%, #040C1B 100%)",
        minHeight: "90vh",
        paddingTop: 64,
        overflow: "hidden",
        position: "relative",
        ...
        <div className="lp-hero-grid">
          ...
          <div className="lp-hero-left">
            <div style={{
              ...
              <span style={{ color: "#93C5FD", fontSize: 13, fontWeight: 700, letterSpacing: "0.01em" }}>
                {t("hero_badge_full")}
              </span>
            </div>
            ...
            <p style={{
              fontSize: 16, color: "#94A3B8", lineHeight: 1.85,
              marginBottom: 10, maxWidth: 500,
            }}>
              {t("hero_sub1")}
            </p>
            <p style={{
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 4px 32px rgba(37,99,235,0.45)", transition: "all 0.2s",
                }}
                onMouseEnter={e => {
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 28px", fontFamily: "inherit", transition: "all 0.2s",
                }}
                onMouseEnter={e => {
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              {(["hero_pill_1", "hero_pill_2", "hero_pill_3", "hero_pill_4"] as const).map(key => (
                <span key={key} style={{
                  ...
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    {["#FF5F57", "#FFBD2E", "#28C840"].map((c, i) => (
                      <span key={i} style={{
                        ...
                        background: c, display: "block", boxShadow: `0 0 5px ${c}88`,
                      }} />
                    ))}
                  </div>
                  <div style={{
                    ...
                    borderRadius: 6, height: 26, display: "flex", alignItems: "center",
                    ...
                    <span style={{ fontSize: 11, color: "#64748B" }}>app.thespaceos.com</span>
                  </div>
                </div>
                <img
                  src={HERO_IMG}
                  alt="The Space OS Dashboard"
