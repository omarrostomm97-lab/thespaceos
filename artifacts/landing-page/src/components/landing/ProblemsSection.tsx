  ...
  return (
    <section className="py-24 sm:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="block text-[11px] font-bold tracking-[0.12em] uppercase text-red-500 mb-4">
            {t("eyebrow_problem")}
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {problems.map(({ icon, titleKey, descKey }, i) => (
            ...
            >
              <div className="absolute inset-x-0 top-0 h-[4px] bg-red-500/60" />
              <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-6 bg-red-500/10 border border-red-500/20 text-red-500">
                {icon}
              </div>
              <h3 className="text-base font-semibold text-slate-900 mb-3">{t(titleKey)}</h3>
