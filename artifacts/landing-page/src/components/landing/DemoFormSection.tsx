          ...
          <div style={{
            ...
            {submitted ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <h3 style={{ color: "#0F172A", fontSize: 22, fontWeight: 700, marginBottom: 8 }}>
                  Request Received!
                </h3>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 14 }}>
                  ...
                  <Field label="Business Type" error={errors.businessType}>
                    <select
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: errors.businessType ? "#EF4444" : "#E2E8F0",
                        cursor: "pointer",
                        color: form.businessType ? "#0F172A" : "#9CA3AF",
                      }}
                    >
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      <select
                        ...
                        style={{
                          ...
                          flexShrink: 0,
                          padding: "11px 10px",
                          color: form.preferredTime ? "#0F172A" : "#9CA3AF",
                          cursor: "pointer",
                          fontSize: 12,
                        }}
                      >
                        <option value="" disabled>11:00 — ▾</option>
                        {TIME_SLOTS.map(s => (
