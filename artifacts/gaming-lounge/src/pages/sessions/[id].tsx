      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className={`grid gap-4 ${session.endedAt ? "grid-cols-3" : "grid-cols-2"}`}>
              ...
              {session.endedAt && (
                <div className="bg-secondary/50 p-4 rounded-lg">
                  <p className="text-sm text-muted-foreground">{t("end_time")}</p>
                  <p className="font-bold">{format(new Date(session.endedAt), "hh:mm a")}</p>
                </div>
              )}
              <div className="bg-secondary/50 p-4 rounded-lg">
